...
require.register("calendarUtils.js", function(exports, require, module) {
'use strict';
...
function getWeeksOfMonth(month, year) {
    var monthWeeks = [];
    var firstOfMonth = (0, _moment2.default)().year(year).month(month).date(1);
...
var _calendarUtils = require('./calendarUtils.js');
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   var weeksOfCurrentMonth = (0, _calendarUtils.getWeeksOfMonth)(currentMonth, currentYear);
...
var _user$project$Calendar$init = function (flags) {
	return A2(
		_elm_lang$core$Debug$log,
		'init running',
		{ctor: '_Tuple2', _0: flags, _1: _elm_lang$core$Platform_Cmd$none});
};
...
var _user$project$Calendar$Day = F3(
	function (a, b, c) {
		return {weekDay: a, date: b, month: c};
	});
var _user$project$Calendar$Week = F2(
	function (a, b) {
				...
				A2(
					...
					function (dates) {
						return A2(
							...
							function (weekOfYear) {
								return _elm_lang$core$Json_Decode$succeed(
									{dates: dates, weekOfYear: weekOfYear});
							});
					}))),
		function (monthWeeks) {
			return A2(
